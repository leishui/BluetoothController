...
public class BluetoothActivity extends AppCompatActivity implements
    ...
    private Handler handler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(@NonNull Message msg) {
            switch (msg.what){
                ...
                case MyBluetoothService.MESSAGE_ERRO:{
                    log("readErr: "+msg.obj);
                }
            }
            return false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        v_edge = findViewById(R.id.v_edge);
        et_uuid = findViewById(R.id.et_uuid);
        tv_discovery.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (myBluetoothService != null) {
                    byte[] bytes = {(byte) i};
                    myBluetoothService.write(bytes);
                    Log.d("1008611", String.valueOf(i));
                    i = i == 0 ? 1 : 0;
                }
            }
        });
        ...
        bt_discover.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                AcceptThread acceptThread = new AcceptThread(mBluetooth,BluetoothActivity.this, UUID.fromString(et_uuid.getText().toString()));
                acceptThread.start();
                return true;
            }
        });
            ...
            if (bluetoothSocket != null) {
                try {
                    ...
                    if (bluetoothSocket.isConnected()) {
                        log("连接成功");
                        myBluetoothService = new MyBluetoothService(handler, bluetoothSocket);
